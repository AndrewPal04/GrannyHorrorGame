...
#Winning Text
WinText=Text(screen,"You Win!",100,(255,0,0),screen_width//2,screen_height//2)
...
def firstFloor():
    ...
    while True:
        ...
        DoorRect= pygame.Rect(780, 900, 120, 10)
        ...
        if jack.rect.colliderect(DoorRect) and haveKey:
            WinText.draw()
...
def secondFloor():
    ...
    while True:
        ...
        walls = [
            couchRect, wardrobeRect, boxesRect,
